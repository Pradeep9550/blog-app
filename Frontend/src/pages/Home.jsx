  ...
  return (
    <div>
      ...
      <div className='flex gap-2'>
        ...
        <Slidebar    getAllUserPost={  getAllUserPost}/>
        </div>
              ...
              <div className="w-full flex flex-col items-center ">
                {
                  AllPosts.map((ele) => {
                    ...
                    return <div className="w-[100%] md:w-[50%] lg:w-[50%] relative overflow-hidden mb-3 bg-white rounded-lg shadow-md dark:bg-gray-800">
